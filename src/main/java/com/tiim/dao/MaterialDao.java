...
public class MaterialDao {
	...
	public List<Material> getMaterialDetails(int materialCode)
	{
		...
		try
		{
			...
			if(materialCode != 0)
			{
			    pstmt = con.prepareStatement("Select materialcCode, materialType, materialQty,materialName, uom,minStockLevel,reorderLevel from mst_material Where materialcCode like '%"+materialCode+"%' order by materialcCode");
			}
			else
			{
				System.out.println("Passed Data Materialcode:"+ materialCode);
