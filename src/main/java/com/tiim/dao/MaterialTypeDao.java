...
public class MaterialTypeDao {
	...
	public List<MaterialType> getMaterialTypeDetails(String materialTypeName)
	{
		...
		try
		{
			...
			{
			    pstmt = con.prepareStatement("select materialTypeid, materialTypename, isactive from material_type Where materialTypename like '%"+materialTypeName+"%' order by materialTypeid");
			}
			else
			{
